...
import { LayoutDashboard, MapPin, FileSignature } from 'lucide-react'
import { cn } from '@/lib/utils'

const NAV_ITEMS = [
  { href: '/events', label: 'Dashboard', icon: LayoutDashboard },
  { href: '/events/discover', label: 'Discover Venues', icon: MapPin },
  { href: '/events/contracts', label: 'My Contracts', icon: FileSignature },
]
    ...
    <div className="flex min-h-[calc(100vh-3.5rem)]">
      ...
      <aside className="hidden lg:flex w-64 shrink-0 flex-col border-r border-slate-200 bg-white">
        <div className="px-4 py-6">
          ...
          <nav className="flex flex-col gap-1" aria-label="Events navigation">
