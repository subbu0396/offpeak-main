...
import { LayoutDashboard, List, DollarSign, Megaphone, BadgeCheck } from 'lucide-react'
import { cn } from '@/lib/utils'

const NAV_ITEMS = [
  { href: '/owner', label: 'Dashboard', icon: LayoutDashboard },
  { href: '/owner/listings', label: 'Listings', icon: List },
  { href: '/owner/pricing', label: 'Pricing', icon: DollarSign },
  { href: '/owner/promotions', label: 'Promotions', icon: Megaphone },
  { href: '/owner/verification', label: 'Verification', icon: BadgeCheck },
]
    ...
    <div className="flex min-h-[calc(100vh-3.5rem)]">
      ...
      <aside className="hidden lg:flex w-64 shrink-0 flex-col border-r border-slate-200 bg-white">
        <div className="px-4 py-6">
          ...
          <nav className="flex flex-col gap-1" aria-label="Owner navigation">
